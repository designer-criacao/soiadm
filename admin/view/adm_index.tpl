...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>{$TITULO_SITE} - Dashboard</title>
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="{$GET_SITE_ADM}">{$TITULO_SITE}</a>
  ...
  <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="{$GET_SITE_ADM}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{$PAG_GRAFICO}">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Gráficos</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{$PAG_PEDIDOS}">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="{$PAG_CAD_CLIENTES}">Cadastrar Clientes</a>
            <a class="dropdown-item" href="{$PAG_LISTAR_CLIENTES}">Lista de Clientes</a>
          </div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{$PAG_USUARIOS}">
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © {$TITULO_SITE} {$DATA2}</span>
            </div>
          </div>
        </footer>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Deseja mesmo sair {$USER}?</h5>
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="{$PAG_LOGOFF}">Sair</a>
          </div>
        </div>
      </div>
    </div>
