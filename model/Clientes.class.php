 ...
 */
	...
	function Inserir(){
		...
		$query .=" cli_cpf, cli_ddd, cli_fone, cli_celular, cli_endereco,cli_numero,cli_bairro, cli_cidade,cli_uf,cli_cep,cli_email)";
		
		$query .=" VALUES (:cli_nome,:cli_sobrenome,:cli_data_nasc,:cli_rg,";
		$query .=" :cli_cpf, :cli_ddd, :cli_fone, :cli_celular,:cli_endereco,:cli_numero, :cli_bairro, :cli_cidade,:cli_uf,:cli_cep,:cli_email)";
    ...
    //Função de alterar cliente como usuário ADM
