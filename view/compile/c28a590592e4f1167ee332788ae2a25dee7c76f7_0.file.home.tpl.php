...
?><!-- Banner -->
					<section id="banner">
						<div class="inner">
							<!--<h2>SoI Design</h2>-->
							<h2><img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/logo_soi2.png"></h2>
							<p>Ouse inovar!<br />
							Criamos experiências e estabelecemos<br />
							ações estratégicas com seus clientes. <a href="#"></a>.</p>
							<ul class="actions">
...
/images/criacao_sites.jpg" alt="" /></div><div class="content">
								<h2>Criação de Sites<br />
								Desenvolvimento de Sites Responsivo</h2>
								<p>Quer ser conhecido na internet e ter acesso aos usuários de Mobile? Nós desenvolvemos seu site com layouts responsivos para todos tamanhos de telas, sua empresa estará otimizada para todos os mecanismos de busca.</p>
							</div>
						</section>
						<section class="spotlight">
							<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/midias2.png" alt="" /></div><div class="content">
						...
						<section class="spotlight">
							<div class="image"><img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/design_grafico2.jpg" alt="" /></div><div class="content">
								<h2>Design Gráfico<br />
								Impressos e VTs</h2>
								<p>Cuidamos de toda parte de design gráfico virtual e impressos. Fazemos também, criação de cartões de visita, banner's, panfletos, flyers e logotipos.</p>
							</div>
						</section>
					</section>
				...
				<!-- CTA -->
					<section id="cta" class="wrapper style4">
						<div class="inner">
							<header>
								<h2>Desenvolvendo com amor!</h2>
								<p>Entre em contato para mais informções.</p>
							</header>
							<ul class="actions vertical">
								<li><a href="<?php echo $_smarty_tpl->tpl_vars['PAG_CONTATO']->value;?>
" class="button fit special">Orçamento</a></li>
								<li><a href="<?php echo $_smarty_tpl->tpl_vars['PAG_EMPRESA']->value;?>
" class="button fit">Saiba Mais</a></li>
							</ul>
						</div>
					</section><?php }
}
